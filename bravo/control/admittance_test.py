...
bravo_bullet = p.loadURDF(
    "C:/Users/marcu/OneDrive/Documents/GitHub/bravo-admittance-control/bravo/urdf/bravo7_obj.urdf",
    start_pos,
    start_orientation,
)
...
Md = np.array(
    p.calculateMassMatrix(bravo_bullet, joint_configs)
)  # TODO: Need to verify that the joint configurations between pybullet and kinpy line up
...
joint_vel = np.linalg.pinv(jc) @ np.linalg.inv(
    Md
