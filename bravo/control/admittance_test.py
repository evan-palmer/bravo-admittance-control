...
bravo_kin = kp.build_serial_chain_from_urdf(open("C:/Users/marcu/OneDrive/Documents/GitHub/bravo-admittance-control/bravo/urdf/bravo7.urdf").read(), "ee_link")
...
joint_vel = np.linalg.pinv(jc) @ np.linalg.inv(Md) #@ (-Kd @ x_e_dot - Kp @ (x_d - x_e + Kf @ (f_d - selection_mat @ f_e)))
